...
@section('breadcrumb')
    ...
    <li><a href="{{ route('users.info',$user) }}" class="is-active">اطلاعات کاربری</a></li>
@endsection
            ...
            <div class="col-12 border-radius-3 bg-white margin-bottom-10">
                ...
                <div class="w-100 padding-20 border-radius-3 bg-white margin-left-10 margin-bottom-10">
                    <ul>
                        ...
                        <li>تاریخ تایید ایمیل:
                            <strong>{{ $user->email_verified_at ? \Morilog\Jalali\Jalalian::fromCarbon($user->email_verified_at) : "تایید نشده" }}</strong>
                        </li>
                    </ul>
                </div>
            </div>
