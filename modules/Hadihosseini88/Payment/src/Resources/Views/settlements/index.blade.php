...
@section('breadcrumb')
    <li><a href="{{ route('settlements.index') }}" class="is-active" title="تسویه حساب ها">تسویه حساب ها</a></li>
@endsection
    ...
    <div class="main-content">
        <div class="tab__box">
            <div class="tab__items">
                ...
                <a class="tab__item " href="?status={{ \Hadihosseini88\Payment\Models\Settlement::STATUS_PENDING }}">درخواست تسویه های جدید</a>
                <a class="tab__item " href="?status={{ \Hadihosseini88\Payment\Models\Settlement::STATUS_SETTLED }}">تسویه های واریز شده</a>
                ...
                <form action="" onclick="event.preventDefault();">
                    <div class="t-header-searchbox font-size-13">
                        ...
                        <div class="t-header-search-content ">
                            ...
                            <button class="btn btn-yeknokte_ir">جستجو</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="table__box">
            <table class="table">
                ...
                <tr role="row" class="title-row">
                    ...
                    <th>مبلغ (تومان )</th>
                    <th>وضعیت</th>
                    @can(\Hadihosseini88\RolePermissions\Models\Permission::PERMISSION_MANAGE_SETTLEMENTS)
                    <th>عملیات</th>
                    @endcan
                </tr>
                </thead>
